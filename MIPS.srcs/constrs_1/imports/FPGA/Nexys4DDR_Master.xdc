...
#set_property PACKAGE_PIN D14 [get_ports {JB_top[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {JB_top[1]}]
#set_property PACKAGE_PIN F16 [get_ports {JB_top[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {JB_top[2]}]
#set_property PACKAGE_PIN G16 [get_ports {JB_top[3]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {JB_top[3]}]
#set_property PACKAGE_PIN H14 [get_ports {JB_top[4]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {JB_top[4]}]
#set_property PACKAGE_PIN E16 [get_ports {JB_bot[7]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {JB_bot[7]}]
#set_property PACKAGE_PIN F13 [get_ports {JB_bot[8]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {JB_bot[8]}]
#set_property PACKAGE_PIN G13 [get_ports {JB_bot[9]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {JB_bot[9]}]
#set_property PACKAGE_PIN H16 [get_ports {JB_bot[10]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {JB_bot[10]}]
#

##Pmod Header JC

#set_property -dict {PACKAGE_PIN K1 IOSTANDARD LVCMOS33} [get_ports clk_out]
#set_property -dict { PACKAGE_PIN F6    IOSTANDARD LVCMOS33 } [get_ports { JC_top[2] }]; #IO_L19N_T3_VREF_35 Sch=jc[2]
#set_property -dict { PACKAGE_PIN J2    IOSTANDARD LVCMOS33 } [get_ports { JC_top[3] }]; #IO_L22N_T3_35 Sch=jc[3]
#set_property -dict { PACKAGE_PIN G6    IOSTANDARD LVCMOS33 } [get_ports { JC_top[4] }]; #IO_L19P_T3_35 Sch=jc[4]
#set_property -dict { PACKAGE_PIN E7    IOSTANDARD LVCMOS33 } [get_ports { JC_bot[7] }]; #IO_L6P_T0_35 Sch=jc[7]
#set_property -dict { PACKAGE_PIN J3    IOSTANDARD LVCMOS33 } [get_ports { JC_bot[8] }]; #IO_L22P_T3_35 Sch=jc[8]
#set_property -dict { PACKAGE_PIN J4    IOSTANDARD LVCMOS33 } [get_ports { JC_bot[9] }]; #IO_L21P_T3_DQS_35 Sch=jc[9]
#set_property -dict { PACKAGE_PIN E6    IOSTANDARD LVCMOS33 } [get_ports { JC_bot[10] }]; #IO_L5P_T0_AD13P_35 Sch=jc[10]
